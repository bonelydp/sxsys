...
public class SampleInfoUpdateDTO {
    private String sampleId; // 用于定位记录，但不允许修改
    ...
    private List<SubtypeDetailUpdateDTO> subtypeDetails; // 添加亚型信息
    ...
    public List<SubtypeDetailUpdateDTO> getSubtypeDetails() {
        return subtypeDetails;
    }

    public void setSubtypeDetails(List<SubtypeDetailUpdateDTO> subtypeDetails) {
